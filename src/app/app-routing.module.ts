...
import {AnnouncementViewResolver} from './services/announcement-view.resolver';
...
const appRoutes: Routes = [
  ...
  {
    path: 'ona', component: AnnouncementsViewComponent, children: [
      {
        path: 'moda', component: MainPageComponent, children: [
          {path: 't-shirty', component: AnnouncementsViewComponent},
          {path: 'bluzy', component: MainPageComponent},
